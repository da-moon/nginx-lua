...
python-clean:
	...
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/__pycache__)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/src/__pycache__)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/*/__pycache__)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/src/*/__pycache__)
	- $(call print_running_target, removing '*.py.*' files)
	- $(RM) $(call rwildcard,$(PWD)/*.py.*)
	- $(RM) $(call rwildcard,$(PWD)/cmd/*.py.*)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/*.py.*)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/src/*.py.*)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/*/*.py.*)
	- $(RM) $(call rwildcard,$(PWD)/cmd/upstream/src/*/*.py.*)
	- $(call print_completed_target)
.PHONY:  python
